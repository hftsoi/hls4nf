...
void model_test_float(
    float x_in[N_INPUT_1_1],
    float layer10_out[N_LAYER_8]
) {

    input_t x_in_ap[N_INPUT_1_1];
    nnet::convert_data<float, input_t, N_INPUT_1_1>(x_in, x_in_ap);
...
void model_test_double(
    double x_in[N_INPUT_1_1],
    double layer10_out[N_LAYER_8]
) {

    input_t x_in_ap[N_INPUT_1_1];
    nnet::convert_data<double, input_t, N_INPUT_1_1>(x_in, x_in_ap);
